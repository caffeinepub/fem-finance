...
import type { Lead as _Lead, LeadId as _LeadId, LeadInput as _LeadInput, Timestamp as _Timestamp } from "./declarations/backend.did.d.ts";
...
function to_candid_LeadInput_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: LeadInput): _LeadInput {
