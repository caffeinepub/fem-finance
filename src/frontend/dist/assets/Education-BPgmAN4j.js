import { c as createLucideIcon, u as useLanguage, r as reactExports, j as jsxRuntimeExports, B as BookOpen } from "./index-D9xHnWj1.js";
...
import { A as ArrowLeft } from "./arrow-left-D2aL7756.js";
/**
...
function RichLine({ text, className }) {
  const parts = text.split(/(\*\*[^*]+\*\*)/g);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className, children: parts.map(
    (part) => part.startsWith("**") && part.endsWith("**") ? /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: part.slice(2, -2) }, part) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: part }, `plain-${part}`)
  ) });
}
const ARTICLES = [
  {
...
function BodyLine({
  ...
  if (line.startsWith("• ")) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-start py-0.5", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RichLine, { text: line }) });
}
    ...
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base text-foreground leading-snug truncate", children: title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5 line-clamp-2", children: preview })
        ] })
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-3 bg-card border-b border-border sticky top-0 z-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-muted-foreground flex items-center gap-1 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3" }),
          article.readTime,
          " min read"
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-6 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl text-foreground leading-tight mb-4", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: body.map((line) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        BodyLine,
        {
          line,
          categoryStyle: style
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 p-4 rounded-xl bg-primary/5 border border-primary/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-primary mb-1", children: lang === "HI" ? "विशेषज्ञ सलाह लें" : "Get Expert Advice" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-3", children: lang === "HI" ? "हमारे वित्तीय सलाहकार से निःशुल्क परामर्श करें।" : "Talk to our financial advisor for a free consultation." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: lang === "HI" ? "अभी WhatsApp करें" : "WhatsApp Now"
          }
        )
      ] })
    ] })
...
function Education() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl text-foreground", children: t("Financial Education", "वित्तीय शिक्षा") }),
      ...
      "div",
      {
        ...
        children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: `shrink-0 px-3 py-1.5 rounded-full text-xs font-semibold border transition-smooth touch-target flex items-center ${activeCategory === cat ? "bg-primary text-primary-foreground border-primary" : "bg-card text-foreground border-border hover:border-primary/50"}`,
            children: cat === "All" ? t("All", "सभी") : cat
          },
          cat
        ))
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: filtered.map((article) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ArticleCard,
          {
            article,
            lang,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-xs text-muted-foreground text-center leading-relaxed pb-4", children: t(
